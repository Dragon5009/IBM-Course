...
def scatter_plot(entered_site, payload):
    input_df = spacex_df.loc[(spacex_df['Payload Mass (kg)'] > payload[0]) & (spacex_df['Payload Mass (kg)'] < payload[1])]
    if entered_site == 'ALL':
        filtered_df = input_df
    else:
        filtered_df = input_df.loc[spacex_df['Launch Site'] == entered_site]
